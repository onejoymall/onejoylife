...
<%--            <p class="goods-name">LG휘센 2015년형 크라운2 스페셜 스탠드형 에어컨</p>--%>
                ...
                <tbody class="sec1-tbody">
                    <tr>
                        ...
                        <td class="body-td2 padding-left">
                            <input type="text" name="qna_title" placeholder="50자 이내로 입력해주세요" maxlength="50" value="${detail.qna_title}">
                    ...
                    <tr>
                        ...
                        <td class="body-td2 padding-left">
                            <textarea name=qna_memo placeholder="500자 이내로 입력해주세요"  style="resize:none;" maxlength="500">${detail.qna_memo}</textarea>
            ...
            <div class="button-box">
                <button type="button" id="qnaModifySubmit">수정</button>

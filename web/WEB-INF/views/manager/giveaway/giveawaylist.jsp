...
<%--                    <td>구매수량</td>--%>
                ...
                <c:if test="${not empty productList}">
                    <c:forEach var="productList" items="${productList}">
                        <tr>
                            <td>
                                <input type="checkbox" id="chk" name="chk" value="${productList.giveaway_id}">
                                <input type="hidden" name="product_cd" value="${productList.giveaway_cd}">
                            </td>
                            <td >${productList.giveaway_cd}</td>
...
<%--                            <input type="file" id="goods-imgSmall" name="uploadfile5" placeholder="ex) sample1.jpg" value="4">--%>
                ...
                <button type="button" id="giveawayUpdate" class="btn-red">저장하기</button>

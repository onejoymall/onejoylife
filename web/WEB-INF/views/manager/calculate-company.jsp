...
<!--                             <input type="checkbox" id="src-name"> -->
                    ...
                    <tbody>
                       ...
                       <tr>
				    	...
				    	<c:choose>
                            ...
                            <td>
                                <button type="button" class="goods-list-btn" name="detail" onclick="defaultModalStore11('${list.payment_cd}')" >상세보기</button>
                            </td>
                        </tr>
                        </c:forEach>
    ...
    function defaultModalStore11(payment_cd){
    	alert(payment_cd)
        $(".modal").attr("style", "display:block");
        jQuery.ajax({
            type: 'GET',
            url: '/Manager/calculate-companyDetail',
            data: {"payment_cd":payment_cd},
...
/*     $(document).ready(function(){
    	var store_pur_com_arr = ${searchVO.store_pur_com}
    	$.each(store_pur_com_arr,function(value){
    		console.log(value);
    	})

...
<%--        <a href="index.html" class="goback clearfix">이전 페이지</a>--%>
        <div class="join-form-box">
            <form id="defaultForm" name="defaultForm" method="POST">
            	<input type="hidden" value="product" name="type_name">
                <input type="hidden" value="상품리스트" name="type_text">
                <ul class="info-tab clearfix">
                    <li><a href="/Manager/excelSettingProduct" class="active">상품리스트</a></li>
                    <li><a href="/Manager/excelSettingGiveaway">경품리스트</a></li>

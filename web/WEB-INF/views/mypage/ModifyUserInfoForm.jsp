                ...
                <form action="t" method="POST">
                    ...
                    <div class="r-sec1">
                        ...
                        <table>
                            ...
                            <tr>
                                <td class="padding-left"><span class="span-w">현재 비밀번호</span><input type="password" class="input-ty"></td>
                            </tr>
                            <tr class="dis-none tr-height">
                                <td class="padding-left"><span class="span-w"></span>비밀번호가 정확하지 않습니다.</td>
                            </tr>
                            <tr>
                                <td class="padding-left"><span class="span-w">신규 비밀번호</span><input type="password" class="input-ty"></td>
                            </tr>
                            <tr class="dis-none tr-height">
                                <td class="padding-left"><span class="span-w"></span>비밀번호는 6~20자의 영문, 숫자를 조합하여 입력하여 주세요. </td>
                            </tr>
                            <tr>
                                <td class="padding-left"><span class="span-w">비밀번호 다시 입력</span><input type="password" class="input-ty"></td>
                            </tr>
                            <tr class="dis-none tr-height">
                    ...
                    <div class="r-sec2">
                        ...
                        <div class="box1">
                            <div class="box1-in">
                                ...
                                <a href="/MyPage/ModifyUserInfoExit">회원탈퇴</a>
                            </div>
                        </div>
                    </div>
                    <div class="r-sec3">

                                ...
                                <c:forEach var="paymentList" items="${paymentList}" varStatus="status">
                                    <tr>
                                        ...
                                        <td class="pointer">
                                            ...
                                            <div class="lis-txt-box lis-txt-box1-2 dis-none">
                                                <span>주문상세</span>
                                            </div>
...
<%--                                    </a>--%>
<%--                                </td>--%>
<%--                                <td class="lis-font-w"><span>3,099,000</span><span>원</span></td>--%>
<%--                                <td class="lis-font-w"><span>2</span></td>--%>
<%--                                <td class="lis-font-w"><span>3,099,000</span><span>원</span></td>--%>
<%--                                <td class="pointer">--%>
<%--                                    <p class="lis-font-w">주문접수</p>--%>
<%--                                    <p class="lis-font-w dis-none">결제완료</p>--%>
<%--                                    <p class="lis-font-w dis-none">상품준비중</p>--%>
<%--                                    <p class="lis-font-w dis-none">배송중</p>--%>
<%--                                    <p class="lis-font-w dis-none">배송완료</p>--%>

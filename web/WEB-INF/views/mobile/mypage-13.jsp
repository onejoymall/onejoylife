...
<%@ include file="/WEB-INF/views/mobile/layout/sub-header.jsp" %>
    <section class="subheader">
        ...
        <ul class="taps">
            <li><a href="javascript:show(1)" id="tap1" class="active">국내 배송주소</a></li>
            <li><a href="javascript:show(2)" id="tap2">해외 배송주소</a></li>
        </ul>
    </section>
    <section class="wrap clearfix" id="write">
        ...
        <table>
            ...
            <thead class="lis-head">
                <tr>
                    <th colspan="2" class="c-btn">
                        <button type="button">선택주소지 수정</button>
                        <button type="button">선택주소지 삭제</button>
                    </th>
                </tr>
            </thead>
            <tbody class="lis-body">
                <tr>
                    <td class="lis-td-con">
                        <p><span>06643 서울특별시 서초구 서리풀길 4 영호빌딩 4층</span></p>
                        <p><span>홍길동</span></p>
                        <p><span>010-1234-5678</span></p>
                    </td>
                    <td class="lis-td-p">
                        <input type="radio" id="shipping01" name="shipping"><label for="shipping01"></label>
                    </td>
                </tr>
                <tr>
                    <td class="lis-td-con">
                    ...
                    <td class="lis-td-p">
                        <input type="radio" id="shipping02" name="shipping"><label for="shipping02"></label>
                    </td>
                </tr>
                <tr>
                    <td class="lis-td-con">
                    ...
                    <td class="lis-td-p">
                        <input type="radio" id="shipping03" name="shipping"><label for="shipping03"></label>
                    </td>
                </tr>
                <tr>
                    <td class="lis-td-con">
                    ...
                    <td class="lis-td-p">
                        <input type="radio" id="shipping04" name="shipping"><label for="shipping04"></label>
                    </td>
                </tr>
                <tr>
                    <td class="lis-td-con">
                    ...
                    <td class="lis-td-p">
                        <input type="radio" id="shipping05" name="shipping"><label for="shipping05"></label>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="fot-btn">
            ...
            <button type="button">기존배송지로 등록</button>
        </div>
    </section>
    <section class="wrap clearfix" id="list">
       ...
       <table>
            ...
            <tbody class="lis-body">
                <tr>
                    <td class="lis-td-con">
                        <p><span>19950 E WALNUT DR N, WALNUT, CA 91789,
                            SCHENECTADY, NEW YORK 12345 US</span></p>
                            <p><span>GILDONGHONG</span><span class="basic-r">(기본)</span></p>
                            <p><span>010-1234-5678</span></p>
                    </td>
                    <td class="lis-td-p">
                        <input type="radio" id="shipping1-01" name="shipping1"><label for="shipping1-01"></label>
                    </td>
                </tr>
                <tr>
                    <td class="lis-td-con">
                        <p><span>19950 E WALNUT DR N, WALNUT, CA 91789,
                            SCHENECTADY, NEW YORK 12345 US</span></p>
                            <p><span>GILDONGHONG</span></p>
                            <p><span>010-1234-5678</span></p>
                    </td>
                    <td class="lis-td-p">
                        <input type="radio" id="shipping1-02" name="shipping1"><label for="shipping1-02"></label>
                    </td>
                </tr>
                <tr>
                    <td class="lis-td-con">
                    ...
                    <td class="lis-td-p">
                        <input type="radio" id="shipping1-03" name="shipping1"><label for="shipping1-03"></label>
                    </td>
                </tr>
                <tr>
                    <td class="lis-td-con">
                    ...
                    <td class="lis-td-p">
                        <input type="radio" id="shipping1-04" name="shipping1"><label for="shipping1-04"></label>
                    </td>
                </tr>
                <tr>
                    <td class="lis-td-con">
                    ...
                    <td class="lis-td-p">
                        <input type="radio" id="shipping1-05" name="shipping1"><label for="shipping1-05"></label>
                    </td>
                </tr>
            </tbody>
        </table>

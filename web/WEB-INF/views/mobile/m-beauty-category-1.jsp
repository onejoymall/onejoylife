            ...
            <div class="inner clearfix">
                ...
                <div class="point-product-list">
                    ...
                    <div class="point-product-item">
                        ...
                        <p class="info-price">
                            <span class="price-before"><fmt:formatNumber value="${list.product_user_payment}" groupingUsed="true" />원</span><fmt:formatNumber value="${list.product_payment}" groupingUsed="true" />원
                        </p>
                        <p class="info-score">
                            <i class="star-ic"></i>

...
public class MgSalesDAO {
    ...
    public List<Map<String, Object>> getCompSalesList(HashMap params) throws SQLException {
        List<Map<String, Object>> getCompSalesList = sql.selectList("mall.MgSalesMapper.getCompSalesList",params);
        return getCompSalesList;
    }
    public Integer getCompSalesListCount(HashMap params) throws SQLException{
        Integer getCompSalesListCount =sql.selectOne("mall.MgSalesMapper.getCompSalesListCount",params);
        return getCompSalesListCount;
    }
    ...
    public List<Map<String, Object>> getAgeSalesList(HashMap params) throws SQLException {
        List<Map<String, Object>> getAgeSalesList = sql.selectList("mall.MgSalesMapper.getAgeSalesList",params);
        return getAgeSalesList;
    }
    public Integer getAgeSalesListCount(HashMap params) throws SQLException{
        Integer getAgeSalesListCount =sql.selectOne("mall.MgSalesMapper.getAgeSalesListCount",params);
        return getAgeSalesListCount;
    }

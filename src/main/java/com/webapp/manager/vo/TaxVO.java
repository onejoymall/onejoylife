...
public class TaxVO extends SearchVO {
	private String invoicee_party_type;
	...
	public void setInvoicee_party_type(String invoicee_party_type) {
		this.invoicee_party_type = invoicee_party_type;
	}
	...
	public void setPurpose_type(int purpose_type) {
	...
	public void setChargeableUnit(String chargeableUnit) {
	...
	public String getMgt_num() {
		return mgt_num;
	}
	public void setMgt_num(String mgt_num) {
		this.mgt_num = mgt_num;
	}

...
//            }
    ...
    //sns Redirect Url
    @RequestMapping(value = "/sign/kakao", method = RequestMethod.GET, produces = "application/json")
    public HashMap<String, Object> loginKakao(@RequestParam HashMap params,HttpSession session,UserInfo userInfo){
        Map<String, Object> postToken = null;
        HashMap<String, Object> resultMap = new HashMap<String, Object>();
        try {
...
//
    ...
    //로그인 sns
    @RequestMapping(value = "/sign/kakaoLogin", method = RequestMethod.POST, produces = "application/json")
    public HashMap<String, Object> loginKakaoLogin(@RequestParam HashMap params , HttpServletRequest request, HttpServletResponse response, HttpSession session) throws  Exception
    {
        Map<String, Object> postToken = null;
        HashMap<String, Object> resultMap = new HashMap<String, Object>();
        try {
...
//            Content-type: application/x-www-form-urlencoded;charset=utf-8
            //https://kauth.kakao.com/oauth/authorize?client_id=edae5e01f6d81723613c9cd06f550593&response_type=code

//            Map<String, Object> kakaoMap = CurlPost.getAccessToken();
//            companylist = CurlPost.sendGet(
//                    "https://kauth.kakao.com/oauth/authorize",
//                    "",
//                    "Bearer "+params.get("access_token")
//            );
          //로그인 되어있으면 로그아웃안내
